  ...
  virtual void Execute(vtkObject *caller, unsigned long, void*)
    {
      ...
      if (this->Mapper)
		...
		this->Mapper2->AddClippingPlane(0,planes->GetPlane(5)); //Mehdi
		planes->Delete();
        }
    }
  ...
  switch ( vi.blendType )
    ...
    case 2:
		switch(vol)//Mehdi
		{
			...
			case 2:	colorFun->AddRGBSegment(0.0, 0.0, 0.0, 1.0, 255.0, 1.0, 1.0, 1.0 ); break;//? /*M*/
			case 3:	colorFun->AddRGBSegment(0.0, 1.0, 1.0, 1.0, 255.0, 1.0, 1.0, 1.0 ); break;//? /*M*/
			case 4:	colorFun->AddRGBSegment(0.0, 1.0, 0.0, 1.0, 255.0, 1.0, 1.0, 1.0 ); break;//? /*M*/
			case 5:	colorFun->AddRGBSegment(0.0, 0.0, 1.0, 1.0, 255.0, 1.0, 1.0, 1.0 ); break;//? /*M*/
			case 6:	colorFun->AddRGBSegment(0.0, 1.0, 1.0, 0.0, 255.0, 1.0, 1.0, 1.0 ); break;//? /*M*/
...
int main(int argc, char *argv[])
{
  ...
  // Read the 2 dataset and upper if any
...
/*    // Set the sample distance on the ray to be 1/2 the average spacing
  ...
  double planeOrigin[3]={0.0,0.0,150.0};
